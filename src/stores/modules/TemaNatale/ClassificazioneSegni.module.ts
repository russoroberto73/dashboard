...
const TabellaRef = ref(db, 'temanataleclassificazionesegni')
...
export const TemaNataleClassificazioneSegni = defineStore('TemaNataleClassificazioneSegni', {
  state: () => ({
    Collezione: [] as TypeCollezione
  }),
  getters: {
    getNomeTabella: () => {
      return 'TemaNataleClassificazioneTemi'
    },
    getElenco: (state) => {
